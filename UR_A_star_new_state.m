function b = UR_A_star_new_state(state,frontier,explored,nodes)
% UR_A_star_new_state - determine if state is already in search tree
% On input:
...
% Call:
%     b = UR_A_star_new_state(s,OPEN,CLOSED,nodes);
% Author:
%     T. Henderson
%     UU
%     Fall 2019
