function [airways,lane_flights,flights,flights_FN] = ...
    UAM_FNSD_LSD_scenario2(min_start0,max_start0,min_speed,max_speed,...
    num_flights,del_t,h_t)
% UAM_FNSD_LSD_scenario2 - compare FAA-NASA SD with Lane SD
% On input:
...
%       (k).speed)
% Call:
%     [aa,ff,ffFN] = UAM_FNSD_LSD_scenario2(0,60,0.1,0.31,100,0.1,1);
% Author:
%     T. Henderson
%     UU
%     Spring 2020
